          ...
          <div className="flex gap-3">
              ...
              >
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M4 6L8 10L12 6" stroke="#18181B" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
                Genre
              </button>
              <input
             ...
             border-gray-300 border rounded-lg"
              ...
              <div
                ...
                className={`absolute duration-300 top-12 z-30  p-5 bg-white border border-[#E4E4E7] rounded-lg mt-1 data-[shown=true]:visible data-[shown=true]:opacity-100 invisible opacity-0`}
